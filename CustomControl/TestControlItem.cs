...
namespace CustomControl
{
    public class TestControlItem : Panel
    {
        ...
        public static readonly DependencyProperty OrientationProperty =
                DependencyProperty.Register("Orientation", typeof(Orientation), typeof(VirtualizingPanel), new PropertyMetadata(Orientation.Vertical, RequestArrange));
        /// <summary>
        /// 请求重新测量与布局面板
        /// </summary>
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            else
            {
                ...
                //    var itemRequestSize = item.DesiredSize;
                //    offsetX[minIndex] += itemRequestSize.Width * itemFixed / itemRequestSize.Height;
                //}
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            else
            {
                ...
                //    double index = i * (this.DesiredSize.Height + StatckSpacing) / StatckCount;
                //    offsetY.Add(index);
                //}
                //itemFixed = (finalSize.Height - StatckSpacing * (StatckCount - 1)) / StatckCount;
                ...
                //    item.Arrange(new Rect(offsetX[minIndex], offsetY[minIndex], item.DesiredSize.Width * itemFixed / item.DesiredSize.Height, itemFixed));
                //    offsetX[minIndex] += (item.DesiredSize.Width * itemFixed / item.DesiredSize.Height + ItemsSpacing);
                //}
            }
